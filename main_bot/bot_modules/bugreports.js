...
let suggestionChannels = ["1097499467407695902"]; // Swapped to BugReports

let tagsToApplyOnNewSuggestion = ["New"]; // tags that will be applied when the message is sent
let tagsToIgnoreOnNewSuggestion = ["Solved", "In Progress"]; // if the message has any of these tags, don't create a new suggestion
...
let tagsToRemoveOnResolveSuggestion = ["New", "High Priority"]; // list of tags that will be removed when a suggestion is resolved (do not include tags that resolve suggestions -> "Approved", etc.)
...
const resolveSuggestionTags = [
    {name: "Solved", tagsToRemove: ["New", "In Progress"]},
];
...
exports.onNewBugReport = (client, msg) => {
...
exports.resolveBugReport = (client, Events) =>{
